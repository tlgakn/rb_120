...
Discussion
We/ve made some minor changes. First, we updated #initialize to handle initialization of the range and the number of guesses allowed, which we store in @range and @max_guesses, respectively. We then replaced the RANGE and MAX_GUESSES constants in the rest of the code, and deleted the constant declarations.