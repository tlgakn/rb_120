...
class Human < Player
  ...
  def choose
    ...
    #self.move = Move.new(choice) => After moving the methods '>' and '<' to the subclasses, this causes an error because there is no method in the current class.
    self.move = Kernel.const_get(choice.capitalize).new # This will give us the class name of the choice and instantiate an object directly from the class
    binding.pry
  end
end
